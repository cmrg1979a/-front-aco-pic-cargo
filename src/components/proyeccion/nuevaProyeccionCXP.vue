<template>
  <v-container fluid>
    ...
    <v-card-actions>
      <v-spacer></v-spacer>
      <v-btn small class="mx-1" color="success" @click="registrar()" rounded
        >Registrar</v-btn
      >
      <v-btn small class="mx-1" dark color="red" @click="volver()" rounded
        >Cancelar</v-btn
      >
      <!-- <v-btn small class="mx-1" color="info" rounded>APROBAR</v-btn> -->
    </v-card-actions>
  </v-container>
</template>

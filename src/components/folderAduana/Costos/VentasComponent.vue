<template>
  <v-container fluid>
    ...
    <div class="">
      <span class="title"
        >Ventas {{ currencyFormat($store.state.aduana.totalVenta) }}</span
      >
            ...
            <v-row>
              <v-col cols="12">
                <v-autocomplete
                  dense
                  autocomplete="none"
                  :items="$store.state.aduana.listTipoCostos"
                  label="Tipo"
                  item-value="codigo"
                  item-text="name"
  ...
  methods: {
    ...
    calcTotal() {
      this.$nextTick(() => {
        ...
        // this.$store.state.aduana.totalVenta = this.totalOption;
        this.$store.commit("setTotalVenta", this.totalOption);
      });
    },
